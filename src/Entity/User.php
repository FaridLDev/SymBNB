 ...
 * @UniqueEntity(
 *     fields={"email"},
 *     message="Un autre utilisateur s'est déjà inscrit avec cette adresse emai, merci de la modifier"
 * )
 */
class User implements UserInterface
{
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="Vous n'avez pas correctement confirmeé votre mot de passe !")
     */
