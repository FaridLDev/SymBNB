...
class Ad
{
     ...
     * @Assert\Length(min=20, max=255, minMessage="Votre introduction doit faire plus 20 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, max=255, minMessage="Votre description ne peut pas faire moins de 10 caractères")
     */
    private $contents;
