...
class Booking
{
     ...
     * @Assert\GreaterThan(propertyPath="startDate", message="La date d'épart doit être plus éloignée que la date d'arrivée !")
     */
    private $endDate;
    ...
    /**
     * Permet de récupération un tableau des journées qui correspondent à ma réservation
     *
    ...
    /**
     * Nombre de jours entre date de fin et date de départ
     */
